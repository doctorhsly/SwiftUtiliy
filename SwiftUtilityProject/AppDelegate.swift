...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func isVersionNeedUpdate( newVer: NSString , currentVer: NSString) -> Bool {
        
        var result = newVer.caseInsensitiveCompare(currentVer as String);
